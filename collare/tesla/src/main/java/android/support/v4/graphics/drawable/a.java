...
public final class a {
    ...
    public static Drawable f(Drawable drawable) {
        ...
        return Build.VERSION.SDK_INT >= 21 ? !(drawable instanceof b) ? new e(drawable) : drawable : !(drawable instanceof b) ? new d(drawable) : drawable;
    }
    ...
    public static boolean b(Drawable drawable, int i) {
        ...
        if (!f556b) {
            try {
                f555a = Drawable.class.getDeclaredMethod("setLayoutDirection", Integer.TYPE);
    ...
    public static int h(Drawable drawable) {
        ...
        if (!f558d) {
            try {
                f557c = Drawable.class.getDeclaredMethod("getLayoutDirection", new Class[0]);
                f557c.setAccessible(true);
            } catch (NoSuchMethodException e) {
