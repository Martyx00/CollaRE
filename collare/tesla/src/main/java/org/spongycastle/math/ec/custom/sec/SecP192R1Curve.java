...
public class SecP192R1Curve extends ECCurve.AbstractFp {
    ...
    public SecP192R1Curve() {
        super(q);
        this.f6425a = fromBigInteger(new BigInteger(1, Hex.decode("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC")));
        this.f6426b = fromBigInteger(new BigInteger(1, Hex.decode("64210519E59C80E70FA7E9AB72243049FEB8DEECC146B9B1")));
