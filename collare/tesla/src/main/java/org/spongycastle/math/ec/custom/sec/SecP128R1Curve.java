...
public class SecP128R1Curve extends ECCurve.AbstractFp {
    ...
    public SecP128R1Curve() {
        super(q);
        this.f6425a = fromBigInteger(new BigInteger(1, Hex.decode("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f6426b = fromBigInteger(new BigInteger(1, Hex.decode("E87579C11079F43DD824993C2CEE5ED3")));
