...
public class LongArray implements Cloneable {
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i, int[] iArr) {
        ...
        for (int i8 = 56; i8 >= 0; i8 -= 8) {
            for (int i9 = 1; i9 < i2; i9 += 2) {
                int i10 = (int) (jArr5[i9] >>> i8);
                addBoth(jArr6, i9 - 1, jArr3, iArr2[i10 & 15], jArr4, iArr2[(i10 >>> 4) & 15], i5);
            }
        ...
        for (int i11 = 56; i11 >= 0; i11 -= 8) {
            for (int i12 = 0; i12 < i2; i12 += 2) {
                ...
                addBoth(jArr6, i12, jArr3, iArr2[i13 & 15], jArr4, iArr2[(i13 >>> 4) & 15], i5);
            }
            if (i11 > 0) {
                shiftUp(jArr6, 0, i4, 8);
            }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        long[] jArr2 = new long[(i10 + i5 + 1)];
        int i12 = i8;
        interleave(longArray3.m_ints, 0, jArr2, 0, i3, 4);
        System.arraycopy(longArray2.m_ints, 0, jArr2, i3, i4);
        int i13 = i3;
        int i14 = 1;
        while (i14 < 8) {
            int i15 = i13 + i7;
            shiftUp(jArr2, i3, jArr2, i15, i7, i14);
            i14++;
            i13 = i15;
        }
        int i16 = 0;
        ...
        while (true) {
            length--;
            if (length <= i2) {
                return reduceResult(jArr2, iArr2[i2], i5, i, iArr);
            }
            if ((((long) length) & 1) == 0) {
                addShiftedUp(jArr2, iArr2[length >>> 1], jArr2, iArr2[length], i5, 16);
            } else {
                distribute(jArr2, iArr2[length], iArr2[length - 1], iArr2[i2], i5);
            }
        }
    }
    ...
    private static long interleave3_13to65(int i) {
        ...
        return (((long) iArr[i & CertificateBody.profileType]) & 4294967295L) | ((((long) iArr[i >>> 7]) & 4294967295L) << 35);
    }
