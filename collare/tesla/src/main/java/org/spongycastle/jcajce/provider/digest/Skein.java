...
public class Skein {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        private void addSkeinMacAlgorithm(ConfigurableProvider configurableProvider, int i, int i2) {
            ...
            configurableProvider.addAlgorithm("Mac." + str, PREFIX + "$SkeinMac_" + i + b.ROLL_OVER_FILE_NAME_SEPARATOR + i2);
            configurableProvider.addAlgorithm("Alg.Alias.Mac.Skein-MAC" + i + "/" + i2, str);
            StringBuilder sb = new StringBuilder();
            sb.append("KeyGenerator.");
            sb.append(str);
            configurableProvider.addAlgorithm(sb.toString(), PREFIX + "$SkeinMacKeyGenerator_" + i + b.ROLL_OVER_FILE_NAME_SEPARATOR + i2);
