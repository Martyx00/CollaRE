                ...
                for (int i5 = 0; i5 < i; i5++) {
                    ...
                    if (binomial.compareTo(bigInteger2) <= 0) {
                        ...
                        if (i4 == i3) {
                            ...
                            binomial = binomial.multiply(BigInteger.valueOf((long) (i3 + 1))).divide(BigInteger.valueOf((long) (i4 - i3)));
                        }
                    }
                }
                return gF2Vector;
            ...
            for (int i10 = 0; i10 < i; i10++) {
                ...
                if (((byte) (bArr2[i10 >>> 3] & (1 << (i10 & 7)))) != 0) {
                    ...
                    if (i8 == i9) {
                        ...
                        binomial = binomial.multiply(new BigInteger(Integer.toString(i9 + 1))).divide(new BigInteger(Integer.toString(i8 - i9)));
                    }
                }
            }
