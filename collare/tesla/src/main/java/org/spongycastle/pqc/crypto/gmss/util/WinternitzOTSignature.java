...
public class WinternitzOTSignature {
    ...
    public WinternitzOTSignature(byte[] bArr, Digest digest, int i) {
        ...
        double d2 = (double) i;
        this.messagesize = (int) Math.ceil(((double) (this.mdsize << 3)) / d2);
        this.checksumsize = getLog((this.messagesize << i) + 1);
        this.keysize = this.messagesize + ((int) Math.ceil(((double) this.checksumsize) / d2));
    ...
    public byte[] getSignature(byte[] bArr) {
        ...
        if (8 % i4 == 0) {
            ...
            int i15 = (this.messagesize << this.w) - i8;
            int i16 = 0;
            while (i16 < this.checksumsize) {
                ...
                int i18 = this.mdsize;
                System.arraycopy(bArr5, 0, bArr2, i9 * i18, i18);
                int i19 = this.w;
                i15 >>>= i19;
                i9++;
                i16 += i19;
            ...
            while (i23 < i21) {
                ...
                for (int i29 = 0; i29 < 8; i29++) {
                    ...
                    int i31 = this.mdsize;
                    System.arraycopy(bArr7, 0, bArr2, i25 * i31, i31);
                    j >>>= this.w;
                    i25++;
                }
                i23++;
            ...
            while (i35 < i34) {
                ...
                int i37 = this.mdsize;
                System.arraycopy(bArr7, 0, bArr2, i25 * i37, i37);
                int i38 = this.w;
                j2 >>>= i38;
                i25++;
                i35 += i38;
            ...
            while (i40 < this.checksumsize) {
                ...
                int i42 = this.mdsize;
                System.arraycopy(bArr7, 0, bArr2, i25 * i42, i42);
                int i43 = this.w;
                i39 >>>= i43;
                i25++;
                i40 += i43;
