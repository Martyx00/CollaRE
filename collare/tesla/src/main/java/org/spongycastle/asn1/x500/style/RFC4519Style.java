...
public class RFC4519Style extends AbstractX500NameStyle {
    ...
    public static final ASN1ObjectIdentifier f6390c = new ASN1ObjectIdentifier("2.5.4.6").intern();
    ...
    public ASN1Encodable encodeStringValue(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        ...
        if (aSN1ObjectIdentifier.equals(f6390c) || aSN1ObjectIdentifier.equals(serialNumber) || aSN1ObjectIdentifier.equals(dnQualifier) || aSN1ObjectIdentifier.equals(telephoneNumber)) {
