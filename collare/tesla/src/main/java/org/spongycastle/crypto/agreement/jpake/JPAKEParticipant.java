...
public class JPAKEParticipant {
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) {
        ...
        if (i >= 40) {
            ...
            this.f6392b = jPAKERound2Payload.getA();
            ...
            JPAKEUtil.validateZeroKnowledgeProof(this.p, this.q, calculateGA, this.f6392b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
            this.state = 40;
        } else {
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        if (i >= 50) {
            ...
            this.password = null;
            BigInteger calculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.p, this.q, this.gx4, this.x2, calculateS, this.f6392b);
            this.x1 = null;
            this.x2 = null;
            this.f6392b = null;
            this.state = 50;
