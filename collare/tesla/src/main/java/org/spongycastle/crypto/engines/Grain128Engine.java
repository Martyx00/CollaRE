    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i < iArr.length) {
                ...
                int i6 = i2 + 1;
                iArr[i] = (bArr3[i2] & 255) | i5 | ((bArr3[i6] << 8) & CipherSuite.DRAFT_TLS_DHE_RSA_WITH_AES_128_OCB);
                int[] iArr2 = this.lfsr;
                byte[] bArr4 = this.workingIV;
                iArr2[i] = (bArr4[i2] & 255) | (bArr4[i3] << 24) | ((bArr4[i4] << Tnaf.POW_2_WIDTH) & 16711680) | ((bArr4[i6] << 8) & CipherSuite.DRAFT_TLS_DHE_RSA_WITH_AES_128_OCB);
                i2 += 4;
                i++;
            } else {
                return;
