...
public class RijndaelEngine implements BlockCipher {
    ...
    private void InvMixColumn() {
        ...
        for (int i = 0; i < this.BC; i += 8) {
            ...
            j2 |= ((long) ((((mul0xe(i8) ^ mul0xb(i9)) ^ mul0xd(i6)) ^ mul0x9(i7)) & 255)) << i;
            j3 |= ((long) ((((mul0xe(i9) ^ mul0xb(i6)) ^ mul0xd(i7)) ^ mul0x9(i8)) & 255)) << i;
            j4 |= ((long) ((((mul0xe(i6) ^ mul0xb(i7)) ^ mul0xd(i8)) ^ mul0x9(i9)) & 255)) << i;
        }
        this.A0 = j;
        this.A1 = j2;
        this.A2 = j3;
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        while (true) {
            ...
            if (i7 >= i || i8 >= (this.ROUNDS + 1) * (this.BC / 8)) {
                ...
                while (i10 < i4) {
                    ...
                    jArr2[i10] = (((long) (bArr2[i10][i7] & 255)) << ((i8 * 8) % i11)) | jArr2[i10];
                    i10++;
                    bArr2 = bArr2;
                    i4 = 4;
                }
        ...
        int i92 = 0;
        while (i8 < (this.ROUNDS + i2) * (this.BC / 8)) {
            int i12 = 0;
            while (i12 < 4) {
                byte[] bArr3 = bArr2[i12];
                i12++;
                bArr3[c2] = (byte) (bArr3[c2] ^ S[bArr2[i12 % 4][i - 1] & 255]);
            }
            byte[] bArr4 = bArr2[c2];
            int i13 = i92 + 1;
            bArr4[c2] = (byte) (rcon[i92] ^ bArr4[c2]);
            if (i <= 6) {
            ...
            int i21 = 0;
            while (i21 < i && i8 < (this.ROUNDS + i2) * (this.BC / 8)) {
                int i22 = 0;
                while (i22 < 4) {
                    int i23 = this.BC;
