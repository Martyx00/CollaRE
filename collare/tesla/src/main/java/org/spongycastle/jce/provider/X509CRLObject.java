...
public class X509CRLObject extends X509CRL {
    ...
    private CertificateList f6419c;
    ...
    private Set getExtensionOIDs(boolean z) {
        ...
        if (getVersion() != 2 || (extensions = this.f6419c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f6419c.getTBSCertList().getExtensions();
    ...
    public byte[] getEncoded() {
        try {
            return this.f6419c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    private void doVerify(PublicKey publicKey, Signature signature) {
        if (this.f6419c.getSignatureAlgorithm().equals(this.f6419c.getTBSCertList().getSignature())) {
    ...
    public int getVersion() {
        return this.f6419c.getVersionNumber();
    }

    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f6419c.getIssuer().toASN1Primitive()));
    }

    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f6419c.getIssuer().getEncoded());
    ...
    public Date getThisUpdate() {
        return this.f6419c.getThisUpdate().getDate();
    }

    public Date getNextUpdate() {
        if (this.f6419c.getNextUpdate() != null) {
            return this.f6419c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f6419c.getRevokedCertificateEnumeration();
    ...
    public byte[] getTBSCertList() {
        try {
            return this.f6419c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
            throw new CRLException(e.toString());
        }
    }
    ...
    public byte[] getSignature() {
        return this.f6419c.getSignature().getOctets();
    }
    ...
    public String getSigAlgOID() {
        return this.f6419c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        if (certificate.getType().equals("X.509")) {
            Enumeration revokedCertificateEnumeration = this.f6419c.getRevokedCertificateEnumeration();
            X500Name issuer = this.f6419c.getIssuer();
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.isHashCodeSet || !x509CRLObject.isHashCodeSet || x509CRLObject.hashCodeValue == this.hashCodeValue) {
            return this.f6419c.equals(x509CRLObject.f6419c);
        }
        return false;
    }
