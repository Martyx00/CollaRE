...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Set getExtensionOIDs(boolean z) {
        Extensions extensions = this.f6418c.getExtensions();
        if (extensions == null) {
            return null;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof X509CRLEntryObject) {
            return this.f6418c.equals(((X509CRLEntryObject) obj).f6418c);
        }
    ...
    public byte[] getEncoded() {
        try {
            return this.f6418c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public BigInteger getSerialNumber() {
        return this.f6418c.getUserCertificate().getValue();
    }

    public Date getRevocationDate() {
        return this.f6418c.getRevocationDate().getDate();
    }

    public boolean hasExtensions() {
        return this.f6418c.getExtensions() != null;
    }
