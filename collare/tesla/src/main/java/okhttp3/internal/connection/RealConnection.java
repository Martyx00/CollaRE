...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:18:0x0090 A[Catch:{ IOException -> 0x00fb }] */
    ...
    private Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) {
        ...
        while (true) {
            ...
            } else if (this.source.b().f() && this.sink.b().f()) {
                return null;
            } else {
    ...
    private Request createTunnelRequest() {
        Request build = new Request.Builder().url(this.route.address().url()).method("CONNECT", null).header("Host", Util.hostHeader(this.route.address().url(), true)).header("Proxy-Connection", "Keep-Alive").header(a.HEADER_USER_AGENT, Version.userAgent()).build();
